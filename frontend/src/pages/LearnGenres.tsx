  ...
  return (
    <div style={{ padding: isSmall ? 12 : 20 }}>
      ...
      {Object.entries(categories).map(([categoryName, lessons]) => {
        ...
        return (
          <div key={categoryName} style={{ marginTop: 10, marginBottom: 20, padding: 12, background: "#fff", border: "3px solid #666", borderRadius: 10 }}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: 10, flexDirection: isSmall ? "column" : "row", gap: isSmall ? 8 : 10, textAlign: isSmall ? "center" : "left" }}>
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns: isSmall ? "1fr" : "repeat(4, minmax(0, 1fr))", // 4列に均等配置
                gap: 10,
                width: "100%",
              }}
            >
